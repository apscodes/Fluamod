...
FLUAMOD::FLUAMOD()
{
	...
	if (!Setup_FMOD()) { printf("Failed to Setup FMOD.\n"); return; }
...
int FLUAMOD::LuaPlaySound(lua_State * L)
{
	...
	//*! One Argument - PlaySound(string soundFile);
	case 1:
	{
	...
	//*! Two Arguments - PlaySound(string soundFile, float playBackFrequency);
	case 2:
	{
